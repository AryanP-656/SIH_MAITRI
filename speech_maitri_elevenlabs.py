"""
MAITRI Speech-to-Speech Interface with ElevenLabs
...
class SpeechMAITRIElevenLabs:
    """Speech-to-speech interface for MAITRI with ElevenLabs TTS"""
...
def main():
    """Main function"""
    print("🚀 MAITRI Speech Interface with ElevenLabs")
    print("=" * 50)
    ...
    try:
        speech_maitri = SpeechMAITRIElevenLabs(gemini_api_key, elevenlabs_api_key)
